        ...
        <div className="lg:col-span-7">
          ...
          <div className="space-y-4 max-w-xl text-base leading-relaxed text-foreground/85">
            <p>
              ...
              Most of the code I ship is written by agents. Thus my work moves
              upstream - setting the constraints, defining the observability
              standards, and designing the evaluation experiments; the agents
              implement against that specification.
            </p>
            <p>
              Just like in adaptive complex systems, unexpected outcomes are
              bound to emerge from time to time with agentic workflows. These
              "emergent" outcomes point to limitations I don't yet understand,
              so I design harnesses — interfaces, autoresearch loops, decision
              rules — that let me steer without needing to determine every
              result. A systems mindset is not about drawing boxes; it is about
              making the work inspectable, repeatable, and accountable. It lets
              me focus on the object that matters: a user behind a product or a
              question behind a research project.
            </p>
          </div>
        </div>
